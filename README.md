...
Eftersom appen riktar sig till barn (från ca 9-13+ år) är säkerheten vår högsta prioritet från dag ett:
...
* **Föräldragodkännande:** Inbyggt flöde där föräldrar måste godkänna kontot innan video/media kan laddas upp.
...
* **Backend (API):** `Node.js (NestJS/Express)` eller `Python (FastAPI)`.
