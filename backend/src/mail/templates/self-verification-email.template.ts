...
<body style="margin:0;padding:0;background-color:#FAFAF7;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Arial,sans-serif;color:#1B1B3A;">
  ...
  es: {
    subject: (teamName) => `Verifica tu cuenta de ${teamName} en SkillStreak`,
    text: (screenName, teamName, consentUrl) =>
      [
        '¡Hola!',
        '',
        `¡Ya casi está! Te has unido a ${teamName} en SkillStreak, una app de rachas de entrenamiento diarias y de un objetivo de puntos compartido por el equipo.`,
        '',
        'Pulsa el enlace de abajo para verificar tu correo y activar tu cuenta.',
        '',
        `Verifica aquí: ${consentUrl}`,
        '',
    ...
    <tr>
      <td align="center">
        <table role="presentation" width="480" cellpadding="0" cellspacing="0" style="background-color:#FFFFFF;border-radius:16px;padding:32px;max-width:480px;">
          <tr>
            <td>
              <h1 style="margin:0 0 16px;font-size:20px;color:#1B1B3A;">Verifica tu cuenta</h1>
              <p style="margin:0 0 12px;font-size:15px;line-height:1.5;">
                ¡Ya casi está! Te has unido a <strong>${safeTeamName}</strong> en SkillStreak
                como <strong>${safeScreenName}</strong>, una app de rachas de entrenamiento diarias y de un objetivo de puntos compartido por el equipo.
              </p>
              <p style="margin:0 0 24px;font-size:15px;line-height:1.5;">
                Pulsa el botón de abajo para verificar tu correo y empezar a registrar entrenamientos.
              </p>
              <table role="presentation" cellpadding="0" cellspacing="0">
                <tr>
                  <td style="border-radius:12px;background-color:#FF6B35;">
